...
3. `data-testid` for elements without obvious semantic role.
4. CSS selectors only as last resort.

Never use auto-generated CSS class names (e.g. `.css-1abc23`) — they change
on every build.
